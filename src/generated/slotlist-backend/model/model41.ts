...
export interface Model41 {
     ...
     */
    error: Model41.ErrorEnum;
    /**
     * Message further describing the error
     */
    message: Model41.MessageEnum;
}
export namespace Model41 {
    export type ErrorEnum = 'Bad Request';
    export const ErrorEnum = {
        Request: 'Bad Request' as ErrorEnum
    }
    export type MessageEnum = 'Invalid mission slot template data';
    export const MessageEnum = {
        Data: 'Invalid mission slot template data' as MessageEnum
    }
}
