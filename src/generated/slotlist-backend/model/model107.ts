...
export interface Model107 {
     ...
     */
    error: Model107.ErrorEnum;
    /**
     * Message further describing the error
     */
    message: Model107.MessageEnum;
}
export namespace Model107 {
    export type ErrorEnum = 'Not Found';
    export const ErrorEnum = {
        Found: 'Not Found' as ErrorEnum
    }
    export type MessageEnum = 'Mission not found' | 'Mission permission not found';
    export const MessageEnum = {
        NotFound: 'Mission not found' as MessageEnum,
        PermissionNotFound: 'Mission permission not found' as MessageEnum
    }
}
