...
export interface Model106 {
     ...
     */
    error: Model106.ErrorEnum;
    /**
     * Message further describing the error
     */
    message: Model106.MessageEnum;
}
export namespace Model106 {
    export type ErrorEnum = 'Not Found';
    export const ErrorEnum = {
        Found: 'Not Found' as ErrorEnum
    }
    export type MessageEnum = 'Mission not found' | 'Mission access not found';
    export const MessageEnum = {
        NotFound: 'Mission not found' as MessageEnum,
        AccessNotFound: 'Mission access not found' as MessageEnum
    }
}
