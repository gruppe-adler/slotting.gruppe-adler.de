...
export interface Model34 {
     ...
     */
    error: Model34.ErrorEnum;
    /**
     * Message further describing the error
     */
    message: Model34.MessageEnum;
}
export namespace Model34 {
    export type ErrorEnum = 'Not Found';
    export const ErrorEnum = {
        Found: 'Not Found' as ErrorEnum
    }
    export type MessageEnum = 'Community not found' | 'Community application not found';
    export const MessageEnum = {
        NotFound: 'Community not found' as MessageEnum,
        ApplicationNotFound: 'Community application not found' as MessageEnum
    }
}
