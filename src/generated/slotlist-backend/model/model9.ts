...
export interface Model9 {
     ...
     */
    error: Model9.ErrorEnum;
    /**
     * Message further describing the error
     */
    message: Model9.MessageEnum;
}
export namespace Model9 {
    ...
    export type MessageEnum = 'Mission slot template not found';
    export const MessageEnum = {
        Found: 'Mission slot template not found' as MessageEnum
    }
}
